...
TensorCraft Core is the teaching operator library of cuda-foundations. It uses a header-only design for easy reading and experimentation. It is **not** a production-grade kernel library: boundary handling, operator coverage, and performance are deliberately scoped for learning.
