...
> [cuflash](https://github.com/open-infra-ai/cuflash)（kernel 深度）。
>
...
- [x] 保持 LEARNING_PATH.md 作为五仓导航的唯一权威入口（2026-08-21 起迁至 meta 仓 `open-infra-ai/open-infra-ai`），新增仓库或改名时同步更新
