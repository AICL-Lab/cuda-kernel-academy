...
// Full forward+backward, WMMA, FlashDecoding: https://github.com/open-infra-ai/cuflash
// Triton reference: trifuse. Runtime generate path: tiny-llm/kernels/attention.cu
